package co.com.nexus.mongo.helper;

import co.com.nexus.mongo.patient.PatientDBRepository;
import co.com.nexus.mongo.patient.PatientRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private PatientDBRepository repository;
    ...
    void setUp() {
        ...
        adapter = new PatientRepositoryAdapter(repository, objectMapper);
